...
class FitnessBookingSerializer(serializers.ModelSerializer):
    class Meta:
        model = FitnessBooking
        fields = [
            'id',
            'fitness',
            'account',
    ...
    def create(self, validated_data):
        ...
        validated_data['total_price'] = duration * fitness.price
    ...
    def validate(self, data):
        ...
        if not data['fitness'].is_available :
            raise serializers.ValidationError("Ce fitness n'est pas disponible pour le moment.")
        return data 